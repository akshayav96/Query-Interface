...
with open("freq_document.dat","rb") as File:
      freq_document = pickle.load( File)

with open("inverse_doc_freq.dat", "rb") as File:
      idf = pickle.load(File)

with open ("length_doc.dat", "rb") as File:
...
with open("document_freq.dat","rb") as file:
